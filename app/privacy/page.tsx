...
export const metadata: Metadata = {
  title: "Privacy Policy | Setu App",
  description: "Learn how Setu App protects your data. Read our Privacy Policy regarding location services, temple finders, and your spiritual information.",
};
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="flex flex-col lg:flex-row gap-12 relative">
          ...
          <aside className="hidden lg:block w-64 flex-shrink-0">
            <div className="sticky top-28 space-y-1 bg-white p-4 rounded-2xl border border-slate-200 shadow-sm">
              ...
              {[
                ...
                <a key={link.id} href={`#${link.id}`} className="block px-3 py-2.5 text-slate-600 hover:text-primary-600 hover:bg-slate-50 rounded-lg text-sm font-medium transition-colors">
                  {link.label}
                </a>
              ))}
            </div>
          ...
          <div className="flex-1 space-y-8 max-w-4xl">
            ...
            {/* Section 1 */}
            <section id="collect" className="bg-white p-8 md:p-10 rounded-2xl shadow-sm border border-slate-200 scroll-mt-28">
              ...
              <p className="text-slate-600 mb-6 leading-relaxed">To provide accurate spiritual services, we may collect:</p>
            ...
            {/* Section 2 */}
            <section id="location" className="bg-white p-8 md:p-10 rounded-2xl shadow-sm border border-slate-200 scroll-mt-28">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-blue-50 text-blue-600 rounded-xl">
                  <MapPin size={24} />
                </div>
                <h2 className="text-2xl font-bold text-slate-800">2. Location & Temples</h2>
              </div>
              ...
              <ul className="space-y-6">
                <li className="flex gap-4 items-start">
                  <div className="bg-slate-100 p-2.5 rounded-lg text-primary-600 mt-0.5"><Eye size={20} /></div>
                  <div>
                    <strong className="block text-slate-800 mb-1">Discover Nearby Temples</strong>
                    <p className="text-slate-500 text-sm leading-relaxed">Show you famous and local temples in your immediate vicinity.</p>
                  </div>
                </li>
                <li className="flex gap-4 items-start">
                  <div className="bg-slate-100 p-2.5 rounded-lg text-primary-600 mt-0.5"><Bell size={20} /></div>
                  <div>
                    <strong className="block text-slate-800 mb-1">Accurate Panchang</strong>
                    <p className="text-slate-500 text-sm leading-relaxed">Calculate sunrise/sunset timings (Tithi) accurately based on your geo-coordinates.</p>
                  </div>
                </li>
              </ul>
            </section>
            ...
            {/* Section 3 */}
            <section id="security" className="bg-white p-8 md:p-10 rounded-2xl shadow-sm border border-slate-200 scroll-mt-28">
              <div className="flex items-center gap-3 mb-6">
